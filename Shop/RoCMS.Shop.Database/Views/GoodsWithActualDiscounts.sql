...
FROM            Shop.GoodsItem LEFT OUTER JOIN
                             (SELECT        GoodsItem_3.HeartId, GoodsItem_3.Name, GoodsItem_3.ManufacturerId, GoodsItem_3.Price, GoodsItem_3.Description, 
                               ...
                               FROM            Shop.GoodsItem AS GoodsItem_3 INNER JOIN
                                                         ...
                                                         Shop.Action ON Shop.Action_Goods.ActionId = Shop.Action.ActionId ON GoodsItem_3.HeartId = Shop.Action_Goods.HeartId
                               WHERE        (Shop.Action.DateOfEnding > GETUTCDATE() OR
                                                         Shop.Action.DateOfEnding IS NULL) AND (Shop.Action.Active = 1)
                               UNION
                               SELECT        GoodsItem_2.HeartId, GoodsItem_2.Name, GoodsItem_2.ManufacturerId, GoodsItem_2.Price, GoodsItem_2.Description, 
                               ...
                               UNION
                               SELECT        GoodsItem_1.HeartId, GoodsItem_1.Name, GoodsItem_1.ManufacturerId, GoodsItem_1.Price, GoodsItem_1.Description, 
