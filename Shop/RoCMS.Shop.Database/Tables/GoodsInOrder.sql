CREATE TABLE [Shop].[GoodsInOrder] (
    ...
    CONSTRAINT [FK_GoodsInOrderGoods] FOREIGN KEY ([GoodsId]) REFERENCES [Shop].[GoodsItem] ([GoodsId]),
    ...
    CONSTRAINT [AK_GoodsInOrderSet_Column] UNIQUE ([GoodsId], [OrderId], [PackId])
);
